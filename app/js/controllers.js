...
.controller('appController', ['$scope', function($scope) {
  ...
  .controller('dynamicBkgController', ['$scope', '$http', function($scope, $http)  {
    ...
    $http.get('https://api.flickr.com/services/rest/?method=flickr.photosets.getPhotos&api_key=' + apiKey + '&photoset_id=' + $scope.imageSet + '&format=json&nojsoncallback=1').success(function(data) {
